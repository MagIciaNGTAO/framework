 ...
 */
@Service
public class LogEntranceService {
    ...
    @Inject
    LogEntranceService(ScopeService scopeService,
    ...
    public void log(Invocation invocation, Executable executable) {
        LogExit preLogger = executable.getDeclaredAnnotation(LogExit.class);
