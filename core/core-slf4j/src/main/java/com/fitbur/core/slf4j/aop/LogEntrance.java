...
public @interface LogEntrance {
    ...
    public static String DEFAULT_MESSAGE = "Entering {{member.name}}";

    /**
     * Set the logger name. If not set it defaults to
     * {@link LogEntrance#DEFAULT_LOGGER}.
     *
     ...
     * {@link LogEntrance#DEFAULT_MESSAGE}.
     *
     * @return log message.
     */
    ...
    /**
     * Message logging level. Defaults to {@link com.fitbur.core.slf4j.aop.Level#DEBUG}
     *
     * @return log level.
     */
