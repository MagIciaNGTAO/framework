...
/**
 * An annotation for marking a method as a gauge, which caches the result for a
 * specified time.
 *
 * <p>
 ...
 * <p>
 *
 * A gauge for the defining class with the name queueSize will be created which
 * uses the annotated method's return value as its value, and which caches the
