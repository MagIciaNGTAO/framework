 ...
 * }</pre>
 * <p>
 * A meter of the field's type will be created and injected into managed
 * objects. It will be up to the user to interact with the metric. This
 * annotation can be used on fields of type Meter, Timer, Counter, and
 * Histogram.
 *
 * <p>
 * This may also be used to register a metric, which is useful for creating a
 * histogram with a custom Reservoir.
 * <pre>{@code
 *     {@literal @}Metric
