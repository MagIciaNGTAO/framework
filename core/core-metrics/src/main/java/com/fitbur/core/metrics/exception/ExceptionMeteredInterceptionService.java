 ...
 */
@Service
public class ExceptionMeteredInterceptionService implements InterceptionService {

    private final List interceptors;

    @Inject
    ExceptionMeteredInterceptionService(List<ExceptionMeteredInterceptor> interceptors) {
